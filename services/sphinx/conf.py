...
# Charles Stern's Blog build configuration file, created by
# `ablog start` on Sun Jan 17 16:18:28 2021.
#
...
blog_authors = {
    'Charles Stern': ('Charles Stern', None),
}
...
project = u'Charles Stern\'s Blog'
copyright = u'2021, Charles Stern'
author = u'Charles Stern'
...
html_theme_path = [alabaster.get_path(), '_static/custom.css']
...
htmlhelp_basename = 'CharlesSternsBlogdoc'
